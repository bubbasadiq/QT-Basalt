...
class ControlConfig:
    ...
    temp_gain_tensile:       float = 4.0
    # Temperature adjustment gain: °C per µm diameter error
    temp_gain_diameter:      float = 1.2
    ...
    max_temp_step_c:         float = 3.0    # °C per cycle
    ...
    safety_max_temp_c:       float = 1620.0
    safety_min_temp_c:       float = 20.0
